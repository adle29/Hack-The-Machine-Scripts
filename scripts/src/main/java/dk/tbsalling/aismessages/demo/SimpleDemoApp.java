...
public class SimpleDemoApp {
    ...
    public void runDemo() throws IOException {
        ...
        String url = "/Users/sniper/Documents/kali_shared_folder/Resources-master/my_notes/src/main/java/dk/tbsalling/aismessages/demo/test.txt";
        ...
        AISInputStreamReader streamReader = new AISInputStreamReader(inputStream, 
            aisMessage ->  System.out.println( 
                    ...
                    Double.valueOf(((DynamicDataReport) aisMessage).getLatitude()) + ","+
                    Double.valueOf(((DynamicDataReport) aisMessage).getLongitude()) )
